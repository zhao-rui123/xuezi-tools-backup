...
HUBS = [
    ('⚡', '执行链路', 'execution_hub', '执行中心 | 语义任务面板 | ACP | screen详情 | 重跑测试任务 | 任务历史 | 后台任务中心'),
    ('📋', '任务与记忆', 'task_hub', '任务面板 | 记忆面板 | 今日重点 | 阻塞 | 高优先级 | Inbox | 摘要'),
    ('🩺', '系统与定时', 'system_hub', '系统面板 | 定时任务中心 | 健康检查 | 备份状态'),
    ('🤖', '模型与控制', 'model_control_hub', '模型面板 | 切换CC模型 | OpenClaw模型 | 会话状态 | 轻控制入口'),
