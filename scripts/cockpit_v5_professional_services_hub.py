...
def build_card(open_id: str = DEFAULT_OPEN_ID) -> dict:
    elements = [
        ...
        {'tag': 'hr'},
        {'tag': 'div', 'text': {'tag': 'lark_md', 'content': '**⚡ 电力及零碳专家** *(开发中)*'}},
        {'tag': 'div', 'text': {'tag': 'lark_md', 'content': '电力行业：电气接线图 / 电价查询 / 储能选型 / 电费清单处理'}},
        {'tag': 'div', 'text': {'tag': 'lark_md', 'content': '零碳领域：零碳园区 / 碳排放计算 / 光储充 / 项目测算'}},
        {'tag': 'action', 'actions': [
            {'tag': 'button', 'text': {'tag': 'plain_text', 'content': '⚡ 电力及零碳专家'}, 'type': 'primary', 'value': qa('电力及零碳专家 agent card', 'feishu.quick_actions.electric_zero_carbon_expert', open_id=open_id)},
        ]},
        {'tag': 'hr'},
