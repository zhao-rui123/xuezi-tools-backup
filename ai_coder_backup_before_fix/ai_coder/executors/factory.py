...
ExecutorInstance = Union[LocalExecutor, RemoteExecutor]
...
class ExecutorFactory:
    ...
    def __init__(self, settings: Settings):
        ...
        self._instances: dict[ExecutorType, ExecutorInstance] = {}

    def create(self, executor_type: ExecutorType) -> ExecutorInstance:
        ...
        if executor_type == ExecutorType.LOCAL:
            ...
            executor = RemoteExecutor(
                ...
                model=remote.model,
                use_direct_codex=self.settings.remote.use_direct_codex if hasattr(self.settings.remote, 'use_direct_codex') else False,
            )
