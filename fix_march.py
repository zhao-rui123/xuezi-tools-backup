...
# 读取文件
with open('/Users/zhaoruicn/.openclaw/workspace/projects/electricity-v4/price-data-clean.js', 'r', encoding='utf-8') as f:
    content = f.read()
...
# 保存
with open('/Users/zhaoruicn/.openclaw/workspace/projects/electricity-v4/price-data-clean.js', 'w', encoding='utf-8') as f:
    f.write(content)
