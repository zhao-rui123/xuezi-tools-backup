...
def fetch_stock_data(code: str, headers: Dict, cookies: Dict) -> Dict:
    """获取股票数据"""
...
def deep_analyze_stock(code: str, name: str, headers: Dict, cookies: Dict) -> Optional[DeepAnalysisResult]:
    """深度分析单只股票"""
    quote = fetch_stock_data(code, headers, cookies)
    if not quote:
        return None
