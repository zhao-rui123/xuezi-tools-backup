...
**技术验证：**
- ✅ autopilot 可以开发完整项目（1704行，~10分钟）
- ✅ `--no-wait` 后台自动驾驶成功
- ✅ 可边开发边做其他事

如需重新部署，用 acpx autopilot 模式重新开发即可。

---

## 股票筛选系统v2 (2026-03-15) ⚠️ 已废弃，被策略B v5替代
...
### 知识库文档
- 本地: knowledge-base/Obsidian笔记命名规范.md
- Obsidian: /雪子助手/命名规范.md

## Obsidian文件夹结构（2026-04-05）
...
### 项目位置
~/.openclaw/workspace/mindvault/

### 发布方式
1. ClawHub: `clawhub publish ~/.openclaw/workspace/mindvault`
2. GitHub: 网络恢复后手动push

## 📚 Obsidian知识库体系 [2026-04-06]

### ⚠️ 同步铁律（2026-04-08新增）

**同步前必须先读规范**:
1. 先读坚果云上的`Obsidian笔记索引.md`
2. 再读`命名规范.md`
3. 确认格式后再上传

**命名格式**: `YYYY.MM.DD-领域-主题.md`
**标签格式**: 内联标签放行尾，不是文件开头
**目录结构**: 生活投资/股票/、AI助手日志/、工作/

**同步后必须更新索引**:
- 新增笔记后更新`Obsidian笔记索引.md`对应分类
- 删除旧文件时同步更新索引
...
### 项目位置
Obsidian: 雪子助手/储能专业Agent开发项目.md

## 📚 Obsidian标签体系v2.0 [2026-04-06]
...
- AI助手日志/模板.md - 日志模板
- 标签管理规范.md - 内联标签规范
- Obsidian笔记索引.md - 更新v2.0

### 标签示例
```markdown
- MindVault发布 #AI/项目 #已完成
- IRR测算完成 #储能/IRR #财务
```
...
### 持仓文件
- `~/.openclaw/workspace/simulator/portfolio.json`
- 核心代码: `~/.openclaw/workspace/simulator/core.py`
- Obsidian同步: `~/.openclaw/workspace/simulator/update_obsidian.py`
