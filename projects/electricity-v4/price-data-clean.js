...
const PRICE_DATA = {
  ...
  "河南": {
    "2026": {
      ...
      "3": {
        "deepValley": { price: 0.2804, hours: [0,1,2,3,4,5], name: "深谷" },
        "valley": { price: 0.4069, hours: [10,11,12,13,14,15], name: "低谷" },
        "flat": { price: 0.7155, hours: [6,7,8,9,16,17,22,23], name: "平段" },
  ...
  "浙江": {
    "2026": {
      ...
      "3": {
        "deepValley": { price: 0.1829, hours: [0,1,2,3,4,5], name: "深谷" },
        "valley": { price: 0.3507, hours: [10,11,12,13,14,15], name: "低谷" },
        "flat": { price: 0.7793, hours: [6,7,8,9,16,17,22,23], name: "平段" },
        "high": { price: 1.2859, hours: [18,19,20,21], name: "高峰" },
        "peak": { price: 1.4145, hours: [], name: "尖峰" },
        "cycles": 2
      },
      "3": {
        "deepValley": { price: 0.1829, hours: [0,1,2,3,4,5], name: "深谷" },
  ...
  "广东": {
    "2026": {
      ...
      "3": {
        "deepValley": { price: 0.2205, hours: [0,1,2,3,4,5], name: "深谷" },
        "valley": { price: 0.2797, hours: [10,11,12,13,14,15], name: "低谷" },
        "flat": { price: 0.6906, hours: [6,7,8,9,16,17,22,23], name: "平段" },
  ...
  "江苏": {
    "2026": {
      ...
      "3": {
        "deepValley": { price: 0.2408, hours: [0,1,2,3,4,5], name: "深谷" },
        "valley": { price: 0.3858, hours: [10,11,12,13,14,15], name: "低谷" },
        "flat": { price: 0.6106, hours: [6,7,8,9,16,17,22,23], name: "平段" },
  ...
  "四川": {
    "2026": {
      ...
      "3": {
        "deepValley": { price: 0.3299, hours: [0,1,2,3,4,5], name: "深谷" },
        "valley": { price: 0.3299, hours: [10,11,12,13,14,15], name: "低谷" },
        "flat": { price: 0.6813, hours: [6,7,8,9,16,17,22,23], name: "平段" },
        "high": { price: 1.0326, hours: [18,19,20,21], name: "高峰" },
        "peak": { price: 1.22, hours: [], name: "尖峰" },
        "cycles": 2
      },
      "3": {
        "deepValley": { price: 0.3299, hours: [0,1,2,3,4,5], name: "深谷" },
  ...
  "天津": {
    "2026": {
      ...
      "3": {
        ...
        "peak": { price: 1.134, hours: [], name: "尖峰" },
        "cycles": 1
      },
      "3": {
        "deepValley": { price: 0.25, hours: [0,1,2,3,4,5], name: "深谷" },
  ...
  "辽宁": {
    "2026": {
      ...
      "3": {
        ...
        "flat": { price: 0.499, hours: [6,7,8,9,16,17,22,23], name: "平段" },
  ...
  "黑龙江": {
    "2026": {
      ...
      "3": {
        ...
        "high": { price: 0.779, hours: [18,19,20,21], name: "高峰" },
  ...
  "新疆": {
    "2026": {
      ...
      "3": {
        ...
        "flat": { price: 0.518, hours: [6,7,8,9,16,17,22,23], name: "平段" },
  ...
  "海南": {
    "2026": {
      ...
      "3": {
        ...
        "high": { price: 1.11, hours: [18,19,20,21], name: "高峰" },
        "peak": { price: 1.221, hours: [], name: "尖峰" },
        "cycles": 1
      },
      "3": {
        "deepValley": { price: 0.25, hours: [0,1,2,3,4,5], name: "深谷" },
  ...
  "云南": {
    "2026": {
      ...
      "3": {
        "deepValley": { price: 0.1985, hours: [0,1,2,3,4,5], name: "深谷" },
        "valley": { price: 0.397, hours: [10,11,12,13,14,15], name: "低谷" },
        "flat": { price: 0.5955, hours: [6,7,8,9,16,17,22,23], name: "平段" },
        "high": { price: 0.8933, hours: [18,19,20,21], name: "高峰" },
        "peak": { price: 0.9826, hours: [], name: "尖峰" },
        "cycles": 1
      },
      "3": {
  ...
  "西藏": {
    "2026": {
      ...
      "3": {
        "deepValley": { price: 0.1856, hours: [0,1,2,3,4,5], name: "深谷" },
        "valley": { price: 0.3712, hours: [10,11,12,13,14,15], name: "低谷" },
        "flat": { price: 0.5568, hours: [6,7,8,9,16,17,22,23], name: "平段" },
        "high": { price: 0.8352, hours: [18,19,20,21], name: "高峰" },
        "peak": { price: 0.9187, hours: [], name: "尖峰" },
        "cycles": 1
      },
      "3": {
