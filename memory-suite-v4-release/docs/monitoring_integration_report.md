...
| 项目 | 评估结果 |
|------|----------|
| 原服务位置 | `/home/user/workspace/services/monitor/monitor_service.py` |
| 功能完整性 | ✅ 完整 |
| 代码质量 | ✅ 良好 |
| 整合可行性 | ✅ 可整合 |
...
```bash
# 每天凌晨 2 点执行日志轮转
0 2 * * * python3 /home/user/workspace/skills/memory-suite-v4/scripts/log_rotate.py --all
```
...
**位置**: `/home/user/workspace/skills/memory-suite-v4/scripts/health_check.py`
...
0 9 * * * python3 /home/user/workspace/skills/memory-suite-v4/scripts/health_check.py --all --notify
```
...
**位置**: `/home/user/workspace/skills/memory-suite-v4/services/monitor_service.py`
...
# 示例代码
subprocess.run([
    "python3", "/home/user/workspace/agents/kilo/broadcaster.py",
    "--task", "send",
    "--message", "🏥 系统健康报告",
...
0 9 * * * python3 /home/user/workspace/skills/memory-suite-v4/scripts/health_check.py --all --notify >> /tmp/health_check.log 2>&1

# 每天凌晨 2 点 - 日志轮转
0 2 * * * python3 /home/user/workspace/skills/memory-suite-v4/scripts/log_rotate.py --all >> /tmp/log_rotate.log 2>&1

# 每 4 小时 - 监控服务健康报告
0 */4 * * * python3 /home/user/workspace/skills/memory-suite-v4/services/monitor_service.py --health >> /tmp/monitor_service.log 2>&1
```
...
# 或使用脚本自动添加
python3 /home/user/workspace/skills/memory-suite-v4/scripts/install_cron.py
```
